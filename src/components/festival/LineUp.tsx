        ...
        <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="flex items-start gap-6 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <h3 className="text-3xl font-bold text-festival-dark mb-2">
                      {artist.name}
                    </h3>
          ...
          <div className="festival-card p-8 bg-gradient-to-r from-festival-green/5 to-festival-pink/5 border-festival-accent/20">
            <div className="text-center">
              <h3 className="text-3xl font-bold text-festival-dark mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold text-festival-dark mb-2">100%</div>

...
export function Activities() {
  const activities = [
    ...
    },
    {
      ...
      description: "Versión física del clásico juego donde los participantes deben cruzar un campo evitando las 'minas' ocultas. Memoria, estrategia y valentía son clave para el éxito.",
